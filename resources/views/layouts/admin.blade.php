...
<li class="nav-item">
<a href="{{route('admin.addParty')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Add PArty</p>
</a>
</li>
<li class="nav-item">
<a href="{{route('admin.manageParty')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Manage Party</p>
</a>
</li>
...
<ul class="nav nav-treeview">
<li class="nav-item">
<a href="{{route('admin.add-gst-bill')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Add Bills</p>
</a>
</li>
<li class="nav-item">
<a href="{{route('admin.manage-gst-bill')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Manage Bills</p>
</a>
</li>
...
<li class="nav-item">
<a href="{{route('admin.print-gst-bill')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>Print</p>
</a>
</li>
